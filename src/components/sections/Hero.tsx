    ...
    <SectionWrapper id="hero" className="justify-center items-center text-center bg-black">
      ...
      <div className="relative z-10 w-full">
        <div className="flex justify-between items-center w-full max-w-7xl mx-auto px-6">
            <h1 className="font-headline text-8xl md:text-9xl lg:text-[18rem] tracking-tighter text-white uppercase leading-none overflow-hidden">
                <AnimatedText text="Ahmed" animation="animate-slide-in-left" />
            </h1>
            <h1 className="font-headline text-8xl md:text-9xl lg:text-[18rem] tracking-tighter text-primary uppercase leading-none overflow-hidden">
                <AnimatedText text="Osman" animation="animate-slide-in-right" />
            </h1>
        </div>
        <p className="text-white/70 mt-4 md:text-xl max-w-2xl mx-auto animate-stagger-in" style={{ animationDelay: '1s' }}>
